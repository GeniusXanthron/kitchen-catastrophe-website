...
<ul class="main">
  ...
  <li><?php if($_SESSION['admin']==1){echo '<a href="about-us-admin.php" class="text">Admin</a>';}?></li>
  <li><?php if($_SESSION['admin']==1){echo '<a href="insert.php" class="text">Insert</a>';}?></li>
